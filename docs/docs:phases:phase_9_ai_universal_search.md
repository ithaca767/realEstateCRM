...
Ranked, linkable results (contacts, engagements, tasks, transactions, professionals)

An AI Answer that is:
...
interpret the question into a search plan

retrieve top K results with both methods
